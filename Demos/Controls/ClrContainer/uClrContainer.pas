...
{$IFEND}
  ...
  CNClrLib.Control.Base, CNClrLib.Control.UserControl,
...
type
  TForm1 = class(TForm)
    ...
    Label1: TLabel;
    ButtonLoadData: TCnButton;
    cboTableName: TCnComboBox;
    procedure FormCreate(Sender: TObject);
    procedure ButtonLoadDataClick(Sender: TObject; E: _EventArgs);
  private
...
begin
  ...
  FDataGridView.BorderStyle := BorderStyle_None;
...
procedure TForm1.ButtonLoadDataClick(Sender: TObject; E: _EventArgs);
begin
  LoadData;
end;
...
begin
  FBindingSource.DataSource := FDataSet.Tables[cboTableName.SelectedIndex];
end;
